        ...
        public override Employee GetById(int id)
        {
            ...
            Employee obj = (from o in service.Context.Employees
                            ...
                            }).ToList().Select(o => new Employee
                            {
                                ...
                                PermanentAddressState = String.IsNullOrEmpty(o.PermanentAddressState)?"Select":o.PermanentAddressState ,
                                ...
                                AddressState = String.IsNullOrEmpty(o.AddressState)  ? "Select" : o.AddressState,
