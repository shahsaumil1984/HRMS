...
/****** Object:  Table [dbo].[TaxComputation]    Script Date: 4/26/2017 12:00:07 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[TaxComputation](
 ...
 CONSTRAINT [PK_TaxComputation] PRIMARY KEY CLUSTERED 
(
...
ALTER TABLE [dbo].[TaxComputation]  WITH CHECK ADD  CONSTRAINT [FK_TaxComputation_Employee] FOREIGN KEY([EmployeeID])
REFERENCES [dbo].[Employee] ([EmployeeID])
GO

ALTER TABLE [dbo].[TaxComputation] CHECK CONSTRAINT [FK_TaxComputation_Employee]
GO
